...
ISR( INT6_vect ) {
  ...
  //byte state = 0;
  state_er = state_er >> 2;
  state_er = state_er | ( newE1_A  << 3 );
  state_er = state_er | ( newE1_B  << 2 );
  //state_er = state_er | ( oldE1_A  << 1 );
  //state_er = state_er | ( oldE1_B  << 0 );
  ...
  // Save current state_er as old state_er for next call.
  //oldE1_A = newE1_A;
  //oldE1_B = newE1_B;
...
ISR( PCINT0_vect ) {
  ...
  //byte state = 0;
  state_el = state_el >> 2; 
  state_el = state_el | ( newE0_A  << 3 );
  state_el = state_el | ( newE0_B  << 2 );
  //state_el = state_el | ( oldE0_A  << 1 );
  //state_el = state_el | ( oldE0_B  << 0 );
